...
echo "mariadb-server-10.5 mysql-server/root_password password vagrant" | debconf-set-selections
echo "mariadb-server-10.5 mysql-server/root_password_again password vagrant" | debconf-set-selections
