...
echo 'subjectAltName = DNS:dev.secretsantaorganizer.com, DNS:phpmyadmin.dev.secretsantaorganizer.com, DNS:mailcatcher.dev.secretsantaorganizer.com' >> /tmp/openssl.cnf
